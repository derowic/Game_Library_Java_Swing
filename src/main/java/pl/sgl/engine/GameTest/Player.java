...
//    }
    ...
    public Player(double animspeed, float x, float y) {
        super(animspeed, x, y);
    }
    ...
    public void updateCalc(double dt, List<GameObject> sprites, InputHandler input) {
...
//                    x += nx * 0.5;
                ...
                if (dotProduct < 0) {
//                    odkomentuj jeśli chcesz aby postać zjeżdzała
//                    velocityX -= dotProduct * nx;
        ...
        if (!onGround) {
            ...
            // Sprawdzamy, czy gracz NIE naciska klawiszy ruchu
            if (!input.isKeyDown(KeyEvent.VK_A) && !input.isKeyDown(KeyEvent.VK_D)) {
//                velocityX = 0; // "Zaciągamy hamulec ręczny"
//                velocityY = 0;
            }
        }
